...
P_SETS = [
    "Workplace_Command_Center_Standard_PermSet_Admin_Full_Access_Cloned",
    "b2w_Admin",
    "b2w_GlobalOperations",
    "b2w_Operations",
    "b2w_OperationsExecutiveAddOn",
    "b2w_Workplace_Operations_Addon",
    "b2w_Workplace_Command_Center_Access",
    "b2w_AdminAddOn",
    "b2w_GlobalOperationsExecutiveAddOn",
    "b2w_GlobalOperationsAddOn"
    ]
#
#
